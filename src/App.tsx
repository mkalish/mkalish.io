      ...
      <Row>
        ...
        <Col>
          ...
          <p className="description">
            Michael Kalish is a software engineer with experience in crafting
            high-quality applications as well as leading high-performing,
          ...
          <p>
            Led and contributed to a cross-functional engineering team to
            deliver high-value features; responsibilities included team
            mentorship, infrastructure maintenance, and technical architecture.
          </p>
          <h5>Projects Included</h5>
          <ul>
            <li>
              Analytics-driven content player and management system that
              provided insights to content developers and instructors
            </li>
            <li>
              Implemented a continuous delivery pipeline that improved the
              release cadence from six weeks to daily
            </li>
            <li>
              Led the adoption of typescript as the language of choice for
              writing frontend applications
            </li>
          </ul>
          ...
          <p>
            ...
            tasked with creating and maintaining Competency-Based Education
            platform.
          </p>
          <h5>Projects Included</h5>
          <ul>
            <li>
              Competency-aligned rubric implementation that enabled linking and
              assessing competencies tied to instructor graded criteria
            </li>
            <li>
              Competency authoring and management tool used by instructional
              designers to create competency rules and hierarchies
            </li>
          </ul>
          ...
          <ul>
            <li>
              UI Architect on the tiger team tasked with rewriting a client’s
              customer service application using .NET and AngularJS
            </li>
            <li>
              Application that included an on-demand timeline of customer
              interactions across all of the client’s points of contact
            </li>
            <li>
              Overhauled the design of a client’s customer service application
            </li>
          </ul>
          <h2>Projects</h2>
          <h3 className="mb-0">
